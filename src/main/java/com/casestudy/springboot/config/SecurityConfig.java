	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		...
		.csrf(csrf->csrf.disable())
			...
			.authorizeHttpRequests((authorize) -> authorize
	                ...
	                .requestMatchers("/api/doctor/add/{userId}").permitAll()
	                .requestMatchers("/api/doctor/getallpatientsbydoc/{id}").hasAuthority("DOCTOR")
//	                .requestMatchers("/api/doctor/add/{userId}").hasAuthority("ADMIN")
